...
### JMP/Jump if condition

The jump instructions are related to setting the machine's program counter, or PC. These instructions set the program counter to a new value, thus "jumping" to another memory address.
